...
const moviesData: Movie[] = [
  {
    id: 1,
    title: 'El Viaje Interestelar',
    genre: 'Ciencia Ficcion',
    duration: 169,
    synopsis: 'Un grupo de astronautas viaja a traves de un agujero de gusano en busca de un nuevo hogar para la humanidad. Una odisea epica que explora los limites del espacio y el tiempo.',
  ...
  },
  {
    ...
    genre: 'Accion',
    duration: 142,
    synopsis: 'Un agente retirado es llamado para una ultima mision que pondra a prueba todos sus limites. Explosiva accion y giros inesperados.',
  ...
  },
  {
    ...
    genre: 'Romance',
    duration: 118,
    synopsis: 'Dos desconocidos se encuentran en la ciudad del amor y descubren que el destino tiene planes para ellos.',
  ...
  {
    id: 4,
    title: 'Terror en la Mansion',
    genre: 'Terror',
    duration: 95,
    synopsis: 'Una familia se muda a una antigua mansion sin saber que no estan solos. El terror acecha en cada rincon.',
    poster_url: '/mansion.jpg',
    rating: 'R',
  ...
  },
  {
    ...
    genre: 'Animacion',
    duration: 105,
    synopsis: 'Un grupo de amigos animales emprende un viaje epico para salvar su bosque. Diversion para toda la familia.',
  ...
  {
    id: 6,
    title: 'El Codigo Secreto',
    genre: 'Suspenso',
    duration: 128,
    synopsis: 'Un criptoanalista descubre un codigo que podria cambiar el curso de la historia. Cada segundo cuenta.',
...
const generateInitialShowtimes = (): Showtime[] => {
  ...
  let id = 1
  // Genera funciones para toda la semana (hoy + 6 días)
